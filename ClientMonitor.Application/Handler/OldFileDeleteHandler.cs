...
namespace ClientMonitor.Application.Handler
{
    ...
    /// </summary>
    public class OldFileDeleteHandler : IOldFileDeleteHandler
    {
        ...
        public OldFileDeleteHandler(INotificationFactory notification)
        {
        ...
        private readonly static List<ListDownloadCloud> _listClouds = new List<ListDownloadCloud>()
        {
            ...
            {
                Name="Ломбард2-ПГ",
                LocDownloadVideo=@"C:\Users\Big Lolipop\Desktop\ЗаписиКамер\Ломбард\Ломбард2",
